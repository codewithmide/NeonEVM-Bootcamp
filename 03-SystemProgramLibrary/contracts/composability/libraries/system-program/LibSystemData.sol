...
library LibSystemData {
    ...
    /// @param accountPubKey The 32 bytes Solana account public key
    /// @return A struct containing all account information
    ...
    /// @param accountPubKey The 32 bytes Solana account public key
    /// @param expectedOwner The expected owner program ID
    /// @param minBalance The minimum lamport balance required
    /// @param expectedExecutable Whether the account should be executable
    /// @return true if all conditions are met, reverts otherwise
